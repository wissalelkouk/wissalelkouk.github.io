...
const ScPillOption = class {
    ...
    render() {
        return (h("button", { key: 'ebad90d9615a92ffa81f2788e23c42a127dcb632', class: {
            ...
            }, tabindex: "0", role: "radio", "aria-checked": this.isSelected ? 'true' : 'false', "aria-disabled": this.isUnavailable ? 'true' : 'false' }, h("slot", { key: '80529ca06f3565b80befc1588ae13010bf2eec82' })));
    }
};
