...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (h("div", { key: 'f658e7682f9fc28684692fd38033279d1bdaaef0', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, h("span", { key: 'c3eec9c1cea74a5f25e7b54dc99cec0ee7e2d94a', part: "prefix", class: "breadcrumb-item__prefix" }, h("slot", { key: '643bbd551b56e53309c80a6e340aa61eada99f06', name: "prefix" })), h(Tag, { key: '18a29ec38b27bba5f8a8e9753f95fd20115802cb', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, h("slot", { key: '245091debe24fa6e4e80fd34b9445ccfd21d5100' })), h("span", { key: '69d40adc2fe1b997054bee6aa069cb1f329c44f4', part: "suffix", class: "breadcrumb-item__suffix" }, h("slot", { key: '8183140c6b384e58fffa9408b3273c3ab5d8c86b', name: "suffix", onSlotchange: () => this.handleSlotChange() })), h("span", { key: '8688760b7a444d0b32850de9df824e7cbc81c542', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, h("slot", { key: '850c7fbbfede3f51103d2fb9431e713f75ea5c44', name: "separator", onSlotchange: () => this.handleSlotChange() }, h("sc-icon", { key: '22653e04188ddc4cf3375f6d280941ccd3f21d5f', name: "chevron-right" })))));
    }
