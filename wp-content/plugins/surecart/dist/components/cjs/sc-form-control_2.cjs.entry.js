...
const ScFormControl = class {
    ...
    render() {
        return (index.h("div", { key: '19de3ea2d4dff87848e2856116036653e12abbb0', part: "form-control", class: {
                'form-control': true,
            ...
            } }, index.h("label", { key: '09435a5a3886be34e61acd920b781a7727be6e7d', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, index.h("slot", { key: '183d8f7362426adb3a2548ff42cef9744fcd7e72', name: "label" }, this.label), index.h("slot", { key: 'da0c1cee8a09f7b09e3aad7c3dc0cc1bbbdb65db', name: "label-end" }), !!this.required && (index.h("span", { key: 'e0633d36d6dc144d93972f2382d6402216e99cb2', "aria-hidden": "true", class: "required" }, ' ', "*")), index.h("sc-visually-hidden", { key: '94ee412cb7d02e28494012626b0685b4d43245b4' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), index.h("div", { key: 'dc6e3f87ed5436f75c7d8956bba6ef2aa6d6dd3c', part: "input", class: "form-control__input" }, index.h("slot", { key: '2480c1df16fa6c746ebfa2a14233d372b7bb08a9' })), this.help && (index.h("div", { key: '0f539eae0a6dd7e57323ef25c5412a8a1cb23183', part: "help-text", id: this.helpId, class: "form-control__help-text" }, index.h("slot", { key: '3d6373c7afbe791a547028786fbf3ba035dc9c3a', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '2a3730094108d958de7b5e951b95abde0dd90977', hidden: this.hidden }, index.h("sc-form-control", { key: 'd04cade321a4b2e7ef07126ce8e946cf24bc2de8', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("slot", { key: '8c553dec751ebfc1a9a84c9368b9cd1be4e408a5', name: "label-end", slot: "label-end" }), index.h("div", { key: 'eb730eff534e43fcd2eab49218cb6abb51fdfbbd', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: 'c5fdfddc5a125ab8b87fddf41d78af5c0205eafb', part: "prefix", class: "input__prefix" }, index.h("slot", { key: 'ffd28d37e7df3e3b1d232641ef00de85e212bd42', name: "prefix" })), index.h("slot", { key: '03eb494c09aca6f59ac2844a81238ef232be9648' }, index.h("input", { key: '7f794ec733a26f5c466590ea2cca7676e35164f6', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), index.h("span", { key: '4862907b86a31c6c8945df19fc01fcb1894720ea', part: "suffix", class: "input__suffix" }, index.h("slot", { key: '588fee0dde4d7d1cb48c0edb26811e17e7b8082e', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: 'aa2fe837178809caa07c3dc5c4761f1f56c4ec26', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: 'd17c3d672c2482f109e90feaaf8ba5b5461ebc27', name: "clear-icon" }, index.h("svg", { key: 'acebbbe753726036cb56b5b4063f87dd4598d194', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: 'bd06f1eb960b6fc2b696072efaede66705be9f65', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: '847298b8fc590da2cbcb1b5a1d6548cec8cd8f69', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
