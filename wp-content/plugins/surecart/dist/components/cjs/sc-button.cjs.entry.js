...
const ScButton = class {
    ...
    render() {
        ...
        const interior = (index.h(index.Fragment, { key: '3dff336ddb1ab3456be4ececb064808939679ae3' }, index.h("span", { key: 'a194e2e3c4eebf1af74961fcb963e1ca94985bc2', part: "prefix", class: "button__prefix" }, index.h("slot", { key: 'f5a9525c8441b75c2780e8339eb89db595ec4e78', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), index.h("span", { key: '7f300f4019f8adf77ff8d2dacdca20936437e734', part: "label", class: "button__label" }, index.h("slot", { key: 'dc18545ef6d38af60c5be0660f32570e41264abd', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '6ad5974680027d604554cb2275d213a9ad0f8bc7', part: "suffix", class: "button__suffix" }, index.h("slot", { key: 'c7e35b5caa622cbd8b385a98da257bebdf5d7b01', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), this.caret ? (index.h("span", { part: "caret", class: "button__caret" }, index.h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("polyline", { points: "6 9 12 15 18 9" })))) : (''), this.loading || this.busy ? index.h("sc-spinner", { exportparts: "base:spinner" }) : ''));
        return (index.h(Tag, { key: '94910eef29a9e3bfc29e1c10b58d6345c4a7ce13', part: "base", class: {
                'button': true,
...
//# sourceMappingURL=sc-button.cjs.entry.js.map