...
const ScSubscriptionVariationConfirm = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '7df45cf8bbfc50029738bcda72ec915eced3b775', heading: this.heading || wp.i18n.__('Enter An Amount', 'surecart'), class: "subscription-switch" }, index.h("sc-card", { key: '6d6a348cecc94fe240151764aad6d6e2f7e738da' }, index.h("sc-form", { key: 'a50988dc888d8fe751a318f837475cc62b6903c7', onScSubmit: this.handleSubmit }, index.h("div", { key: 'a12b937dc9602246a8d227a7d27706f86946d071', class: "sc-product-variation-choice-wrap" }, (((_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.variant_options) === null || _b === void 0 ? void 0 : _b.data) || []).map(({ name, values, id }, index$1) => {
            var _a, _b;
        ...
        })), index.h("sc-button", { key: 'fa1f612f228cf2a2e11b50460f253ed6bfabbc1f', type: "primary", full: true, submit: true, loading: this.busy }, this.buttonText(), " ", index.h("sc-icon", { key: '65568a6859e2bb5c64429e6ce9776630f91b000d', name: "arrow-right", slot: "suffix" })))), this.busy && index.h("sc-block-ui", { key: '0acf4ac2d9683614e7560a0de35008faaef959b6', style: { zIndex: '9' } })));
    }
};
