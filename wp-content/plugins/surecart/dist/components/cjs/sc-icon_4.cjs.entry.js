...
const ScIcon = class {
    ...
    render() {
        return index.h("div", { key: '47af7eccf5b06b1c0e5a27c3484aaa0081a22461', part: "base", class: "icon", role: "img", "aria-label": this.getLabel(), innerHTML: this.svg });
    }
...
const ScProductLineItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'acb31c652369e666ba0772323bb4a764d92f1745', class: "base", part: "base" }, index.h("div", { key: '4200949e59f4f0c5df4410f372b8072d18865445', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_c = this.image) === null || _c === void 0 ? void 0 : _c.src) ? (index.h("img", { ...this.image, part: isImageFallback ? 'placeholder__image' : 'image', class: isImageFallback ? 'item__image-placeholder' : 'item__image' })) : (index.h("div", { class: "item__image-placeholder", part: "placeholder__image" })), index.h("div", { key: '82f5eb7d59528d09f1efd683ecb2a022851a55bb', class: "item__text-container" }, index.h("div", { key: 'cf21770ddef7c26370ca4b93ae12b83d847c519c', class: "item__row" }, index.h("div", { key: '56c046f833d636300b6d5021f24dcf141b1dcabc', class: "item__title", part: "title" }, index.h("slot", { key: '09c60e7f51d89129df4d144a63c0216b532acbff', name: "title" }, this.name)), index.h("div", { key: 'd30573431da79fc330a6f0156c4d904f0bc1d235', class: "price", part: "price__amount" }, !!this.scratch && this.scratch !== this.amount && index.h("span", { key: 'c3f7ff4ac6b16179939f8dbf471b5daf6606ed3e', class: "item__scratch-price" }, this.scratch), this.amount, index.h("div", { key: '8fe7b288da8350315cc27a54cbc03e675b781cd3', class: "price__description", part: "price__description" }, this.interval))), index.h("div", { key: 'cbb34bf3f0cc3981d285af323a4493d952e169c9', class: "item__row" }, index.h("div", { key: '1574b717f3db4caa379df27f7c1bdac18be18045', class: "item__description", part: "description" }, this.variant && index.h("div", { key: 'f6258615ba64013ff07d16027f0419090aafc57e' }, this.variant), this.price && index.h("div", { key: 'a403241ba07d9c0ab96c8205368eec1e7c445f39' }, this.price), this.sku && (index.h("div", { key: '29e252e1885cd58f5acb21371fb7f1a11cd098ca' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku)), !!this.purchasableStatus && index.h("div", { key: '1a57bb5329e4968a449959c98496430c6ece16bf' }, this.purchasableStatus), !!this.note && index.h("sc-product-line-item-note", { key: '6d7799cd8844ec43bf15f8a5c078869142f8e1cb', note: this.note })), index.h("div", { key: '85f5dca906ef31adea6376f0d473bf3bee83c98b', class: "item__description", part: "trial-fees" }, !!this.trial && index.h("div", { key: '09024d942a2b6200fa572f0d9c72159a3636c854' }, this.trial), (this.fees || []).map(fee => {
            return (index.h("div", null, fee === null || fee === void 0 ? void 0 :
                fee.display_amount, " ", fee === null || fee === void 0 ? void 0 :
                fee.description));
        }))), index.h("div", { key: '59f95fadf33b9cfcc341e1bc1493618a3e1bd4da', class: "item__row stick-bottom" }, this.editable ? (index.h("sc-quantity-select", { max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.price) })) : (index.h("span", { class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity)), !!this.removable && (index.h("div", { key: '53bd671f6422947b7174b5036d81aac82e38906b', class: "item__remove-container", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
            }, "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %1$s %2$s', 'surecart'), this.name, this.price), tabIndex: 0 }, index.h("sc-icon", { key: '8017412201ecd5ecc307269fd0183c2904eb4989', exportparts: "base:remove-icon__base", class: "item__remove", name: "x" }), index.h("span", { key: '6162f3401bb9ec7d77aecc813daef39e19c40ec9', class: "item__remove-text" }, wp.i18n.__('Remove', 'surecart')))))))));
    }
...
const ScQuantitySelect = class {
    ...
    render() {
        return (index.h("div", { key: '4e754aec3280773a31926b14c3c09b79704b648e', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, index.h("button", { key: '8f208ff69fa1a4e8855fb86c179e9cb11d47ba0e', part: "minus", "aria-label": wp.i18n.__('Decrease quantity by one.', 'surecart'), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, index.h("sc-icon", { key: '31debc92bac2af36f198ba72a633550a4e150b8c', name: "minus", exportparts: "base:minus__icon" })), index.h("input", { key: '3b6e1888af6714b9248cc7cfa02c3fb646de8e69', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), index.h("button", { key: '7d3b145dafbd1efd8d153364bcb88e7742667fc7', part: "plus", "aria-label": wp.i18n.__('Increase quantity by one.', 'surecart'), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, index.h("sc-icon", { key: '16efc991d1cee8776959a7cf99461b307aad147a', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return index.getElement(this); }
};
