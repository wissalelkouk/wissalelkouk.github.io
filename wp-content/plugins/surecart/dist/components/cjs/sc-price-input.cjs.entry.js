...
const ScPriceInput = class {
    ...
    render() {
        return (index.h("sc-input", { key: '717822f90bd4b067a9c7ec7cb3a18f9ab9c65843', exportparts: "base, input, form-control, label, help-text, prefix, suffix", size: this.size, label: this.label, showLabel: this.showLabel, help: this.help, ref: el => (this.input = el), type: "text" // we cannot use number because it's basically the worst. https://stackoverflow.blog/2022/12/26/why-the-number-input-is-the-worst-input/
            ...
            ,
            value: this.getFormattedValue() }, index.h("span", { key: '0d658ca09d2719d7a2e644b4504d0b3ced56ccd4', style: { opacity: '0.5' }, slot: "prefix" }, price.getCurrencySymbol(this.currencyCode)), index.h("span", { key: 'ee82dcb8f6bfd16ba0dac9e822a04b58dae7959c', slot: "suffix" }, index.h("slot", { key: '2cfa1330e29679186a4f9966b2da27f68443dfc5', name: "suffix" }, this.showCode && (this === null || this === void 0 ? void 0 : this.currencyCode) && index.h("span", { key: 'e262e091030baf65d3dcfbed7831658c541f839d', style: { opacity: '0.5' } }, this.currencyCode.toUpperCase())))));
    }
