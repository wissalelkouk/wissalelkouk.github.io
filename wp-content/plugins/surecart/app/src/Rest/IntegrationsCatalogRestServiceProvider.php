...
use SureCart\Controllers\Rest\IntegrationCatalogController;
use SureCart\Rest\RestServiceInterface;

/**
 * Service provider for Price Rest Requests
 */
class IntegrationsCatalogRestServiceProvider extends RestServiceProvider implements RestServiceInterface {
	/**
	 * Rest Controller
	 *
	 * @var string
	 */
	protected $controller = IntegrationCatalogController::class;
