...
use SureCart\Controllers\Rest\DisplayCurrencyController;

/**
 * Service provider for Price Rest Requests
 */
class DisplayCurrencyRestServiceProvider extends RestServiceProvider implements RestServiceInterface {
	/**
	 * Endpoint.
	 *
	 * @var string
	 ...
	 * @var string
	 */
	protected $controller = DisplayCurrencyController::class;
