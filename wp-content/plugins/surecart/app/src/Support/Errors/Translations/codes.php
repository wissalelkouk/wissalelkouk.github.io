...
return array(
	...
	'customer.shipping_address.active_subscriptions_exist' => __( 'This address cannot be removed if customer has active subscriptions.', 'surecart' ),
	...
	'period.end_at.greater_than_or_equal_to'               => __( 'The renewal date should be greater than or equal to the subscription end date.', 'surecart' ),
