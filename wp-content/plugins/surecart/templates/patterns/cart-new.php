 ...
 */
return [
	'title'      => __( 'Default Cart', 'surecart' ),
	'categories' => [ 'surecart_cart' ],
	'blockTypes' => [ 'surecart/slide-out-cart' ],
	'priority'   => 2,
	'content'    => '<!-- wp:surecart/slide-out-cart {"style":{"typography":{"fontSize":"15px"},"spacing":{"blockGap":"0px"}},"layout":{"type":"default"}} -->
...
<div class="wp-block-group" style="padding-top:1.5em;padding-right:2em;padding-bottom:0em;padding-left:2em">
	<!-- wp:surecart/cart-close-button {"style":{"typography":{"lineHeight":"1"}}} /-->
	...
	<p
		style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;font-size:16px;font-style:normal;font-weight:500;line-height:1">
		Review My Order</p>
	<!-- /wp:paragraph -->
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		<!-- wp:surecart/cart-line-item-image {"aspectRatio":"1","width":"","height":"","style":{"layout":{"selfStretch":"fixed","flexSize":"80px"},"border":{"width":"1px","radius":"4px"},"color":{"duotone":"unset"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} /-->
		...
		<div class="wp-block-group">
			<!-- wp:group {"style":{"layout":{"selfStretch":"fill","flexSize":null},"spacing":{"blockGap":"var:preset|spacing|60"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"stretch","justifyContent":"space-between"}} -->
			<div class="wp-block-group">
				<!-- wp:group {"style":{"layout":{"selfStretch":"fill","flexSize":null},"spacing":{"blockGap":"0px"}},"layout":{"type":"default"}} -->
				<div class="wp-block-group">
					<!-- wp:surecart/cart-line-item-title {"style":{"typography":{"fontStyle":"normal","fontWeight":"500","lineHeight":"1.4","textDecoration":"none"}}} /-->

					<!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"default"}} -->
					<div class="wp-block-group">
						<!-- wp:surecart/cart-line-item-price-name {"style":{"typography":{"fontSize":"14px","lineHeight":"1.4"}}} /-->
					...
					<!-- wp:surecart/cart-line-item-status {"style":{"typography":{"textAlign":"right"}}} /-->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group" style="line-height:1.4">
						<!-- wp:surecart/cart-line-item-scratch-amount /-->

						<!-- wp:surecart/cart-line-item-amount {"style":{"typography":{"fontStyle":"normal","fontWeight":"500","textAlign":"right"}}} /-->

						<!-- wp:surecart/cart-line-item-interval {"style":{"typography":{"fontSize":"14px"}}} /-->
					</div>
					<!-- /wp:group -->

					<!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"default"}} -->
					<div class="wp-block-group">
						<!-- wp:surecart/cart-line-item-trial {"style":{"typography":{"fontSize":"14px","textAlign":"right"}}} /-->

						<!-- wp:surecart/cart-line-item-fees {"style":{"typography":{"fontSize":"14px","textAlign":"right"}}} /-->
					</div>
					<!-- /wp:group -->
				</div>
				<!-- /wp:group -->
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					<!-- wp:surecart/cart-line-item-remove {"style":{"typography":{"fontSize":"14px","fontStyle":"normal","fontWeight":"400"}}} /-->
				</div>
				<!-- /wp:group -->
			</div>
			<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"2em","bottom":"2em","left":"2em","right":"2em"}},"border":{"top":{"color":"#b0b0b069","width":"1px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group"
	style="border-top-color:#b0b0b069;border-top-width:1px;padding-top:2em;padding-right:2em;padding-bottom:2em;padding-left:2em">
	...
	<!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"default"}} -->
	<div class="wp-block-group">
		<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"18px","lineHeight":"1.4"},"spacing":{"margin":{"top":"0px","bottom":"0px"}}}} -->
		<p style="margin-top:0px;margin-bottom:0px;font-size:18px;font-style:normal;font-weight:500;line-height:1.4">
			Subtotal</p>
		<!-- /wp:paragraph -->
		...
		<p class="has-text-color has-link-color" style="color:var(--sc-input-help-text-color);font-size:14px;line-height:1.4">Taxes &amp;
